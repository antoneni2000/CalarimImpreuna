...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <label for="NrTelefon" class="form-label" id ="phone-label">Nr Telefon</label>
                <input type="tel" id="NrTelefon" name="NrTelefon" class="form-input" required>
            </div>

            <div class="form-group">
                <label for="DataNasterii" class="form-label" id ="birthdate-label">Data Nașterii</label>
                <input type="date" id="DataNasterii" name="DataNasterii" class="form-input" required>
            </div>

            <button type="submit" class="btn-submit" id ="submit-button">Înregistrează-te</button>
        </form>
    </div>
